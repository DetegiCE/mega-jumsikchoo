...
class _$RestaurantImpl implements _Restaurant {
  ...
  @override
  String toString() {
    return 'Restaurant(id: $id, name: $name, category: $category, phone: $phone, address: $address, roadAddress: $roadAddress, x: $x, y: $y, url: $url)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, name, category, phone, address, roadAddress, x, y, url);
...
abstract class _Restaurant implements Restaurant {
  factory _Restaurant(
      ...
      required final String url}) = _$RestaurantImpl;
